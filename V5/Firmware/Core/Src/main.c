...
color_t Red = {100, 0 , 0};
color_t Orange = {80, 100, 0};
color_t Blue = {0, 0, 100};
color_t Green = {0, 255, 0};
color_t Purple = {20, 0, 80};
color_t White = {100, 100, 100};
color_t Black = {0, 0, 0};
...
#define PH_BLINK_PERIOD	100
#define PH_WAINTING_TIME 15000
#define INT_PULSE_TIME 100

uint32_t Status_Last_Blink_Timestamp = 0;
uint32_t Interrupt_Start_Timestamp = 0;
/* USER CODE END PV */
